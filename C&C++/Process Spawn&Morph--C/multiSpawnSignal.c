...
/************************************************************************/
// report the result of process counting

void handler()
{
    finishedProcess ++;
    printf("%d process(es) is finished, %d process(es) is still working\n",finishedProcess,totalProcess-finishedProcess);  
}
